...
*/
    ...
    function go(a,b,c){this.m=this.g=this.h=null;this.i=0;this.s=!1;this.l=[];this.j=null;this.G={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.B=c;c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Wb(a.src):"https://www.youtube-nocookie.com"),this.h=new bo(b),c||(b=ho(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.g=a,this.g.id||(this.g.id="widget"+Qa(this.g)),Wn[this.g.id]=this,window.postMessage){this.j=
